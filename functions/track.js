...
export async function onRequestPost(context) {
    ...
    try {
        ...
        if (type === "settings") {
            const allowed = ["siteName","siteAuthor","siteTitle","siteDesc","primaryColor","bismillahText","bismillahSub","bismillahDuration","updateText","rssSources","toolbarBtns","glowColor","glowSpeed","glowOpacity","glowBorderWidth","glowBorderSpeed","sitemapLastmod"];
            const data = {};
